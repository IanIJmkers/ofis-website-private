...
export default function Footer() {
  ...
  const quickLinks = [
    { label: t("nav.home"), path: lang === "en" ? "/en" : "/" },
    {
      label: t("nav.privateOffice"),
      path: `${prefix}${lang === "en" ? "/your-private-office" : "/uw-private-office"}`,
    },
    {
      label: t("nav.about"),
      path: `${prefix}${lang === "en" ? "/about" : "/over-ons"}`,
    },
    {
      label: t("nav.news"),
      path: `${prefix}${lang === "en" ? "/news" : "/nieuws"}`,
    },
    {
      label: t("nav.contact"),
      path: `${prefix}/contact`,
  ...
  const legalLinks = [
    ...
    { label: t("footer.compensation"), path: "#" },
  ];
      ...
      <div className="border-t border-navy-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-8">
          ...
          <p className="text-center text-xs text-navy-500">
            &copy; {new Date().getFullYear()} {siteMetadata.fullName}.{" "}
            {t("footer.rights")}
          </p>
        </div>
      </div>

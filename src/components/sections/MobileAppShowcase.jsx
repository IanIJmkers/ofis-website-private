      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <AnimatedSection direction="left">
          ...
          <p className="text-warm-gray-500 leading-relaxed mb-8">
            Bekijk uw portefeuille, ontvang persoonlijke rapportages en blijf op
            de hoogte van de laatste ontwikkelingen — direct vanaf uw telefoon.
          </p>
          ...
          <div className="flex gap-8">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-navy-900 group-hover:text-gold-700 transition-colors duration-200">
                ...
                <div className="text-left">
                  <p className="text-[10px] leading-none text-warm-gray-400">Download in de</p>
            ...
            >
              ...
              <div className="flex items-center gap-2 text-navy-900 group-hover:text-gold-700 transition-colors duration-200">
                ...
                <div className="text-left">
                  <p className="text-[10px] leading-none text-warm-gray-400">Beschikbaar op</p>
        ...
        <AnimatedSection direction="right" delay={0.15}>
          <div className="flex justify-center lg:justify-end">
            <img
              src={appMock}
              alt="My Orchestra app weergegeven op twee telefoons"
              className="w-full"
            />
          </div>
        </AnimatedSection>
